...
# you might need to use: ~/.rvm/gems/ruby-1.9.3-p484/bin/sass --compass templates/example-aerix/stylesheets/invoice.css.scss:templates/example-aerix/stylesheets/invoice.css
